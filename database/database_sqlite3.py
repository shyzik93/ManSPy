...
class Database:
    ...
    def add_words2group(self, id_type, id_speech, id_group, isword, *id_words):
        return self.relation.add_words2group(id_type, id_speech, id_group, isword, *id_words)

    def get_groups_by_word(self, id_type, isword, id_word, id_speech=None):
        return self.relation.get_groups_by_word(id_type, isword, id_word, id_speech)

    def get_words_by_group(self, id_type, id_group, isword, id_speech=None):
        return self.relation.get_words_by_group(id_type, id_group, isword, id_speech)
