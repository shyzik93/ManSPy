...
class TestGraphemathicalAnalysis(unittest.TestCase):
    def test_define_type_symbol(self):
        ...
        result = analysis_graphemathic.define_type_symbol(word_result)
    ...
    def _test_process_end_of_word(self, source, word, end, end_orig):
        ...
        analysis_graphemathic.process_end_of_word(word_result)
        self.assertEqual(
    ...
    def test_process_words(self):
        ...
        text_result = analysis_graphemathic.process_words(source_string)
