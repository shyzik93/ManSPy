...
- comparing_fasif.txt - результаты сравнения актанта (словосочетания) с словосочетанием в ФАСИФе.
...
В файле run.py происходит создание объекта программы и его передача в модули интерфейсов. Объект программы имеет следующие функции, используемые в МИ:
